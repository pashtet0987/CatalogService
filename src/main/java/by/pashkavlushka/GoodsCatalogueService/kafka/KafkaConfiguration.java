...
public class KafkaConfiguration {
    ...
    public static Map<String, Object> consumerProperties(String kafkaBrokers) {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "inventory");
    ...
    @Bean
    public ConsumerFactory<Instant, GoodsDTO> defaultKafkaConsumerFactory(@Value("${kafka.configuration.bootstrapServers}") String kafkaBrokers) {
        DefaultKafkaConsumerFactory<Instant, GoodsDTO> factory = new DefaultKafkaConsumerFactory<>(consumerProperties(kafkaBrokers));
        return factory;
    }
    ...
    public ConcurrentKafkaListenerContainerFactory<Instant, GoodsDTO> kafkaListenerContainerFactory(@Qualifier("defaultKafkaConsumerFactory") ConsumerFactory<Instant, GoodsDTO> consumerFactory, DefaultErrorHandler handler) {
        ConcurrentKafkaListenerContainerFactory<Instant, GoodsDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
